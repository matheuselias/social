...
class FamiliaControllerTest < ActionController::TestCase
  ...
  test "should create familium" do
    assert_difference('Familium.count') do
      post :create, familium: { inforcacoes: @familium.inforcacoes, nome: @familium.nome, renda: @familium.renda, tipo: @familium.tipo }
    end
  ...
  test "should update familium" do
    patch :update, id: @familium, familium: { inforcacoes: @familium.inforcacoes, nome: @familium.nome, renda: @familium.renda, tipo: @familium.tipo }
    assert_redirected_to familium_path(assigns(:familium))
  end
